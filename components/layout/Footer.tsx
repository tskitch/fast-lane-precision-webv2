  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-grid">
        <div><span className="technical-label">LOCATION</span><p>{company.location}</p><p className="muted">{company.address}</p><a href={`mailto:${company.email}`}>{company.email}</a><a href={company.phoneHref}>{company.phone}</a></div>
        ...
        <div><span className="technical-label">COMPANY</span><Link href="/about">About</Link><Link href="/industries">Industries</Link><RFQLink>Contact / RFQ</RFQLink><Link href="/privacy">Privacy</Link></div>
