...
export function CapabilityDetail(p: Props) {
  return <>
    ...
    <section className="detail-section light-section"><SectionHead index="01" eyebrow="PROCESS" title="Purposeful process selection." />
